...
class ExpenseManager:
    ...
    def get_expenses_by_category(self, category_name) -> list:
        if not self.expense:
            ...
            found_category = [
                items for items in self.expense if items["category"] == category_name
            ]
    ...
    def get_total_expense_by_category(self, category_name):
    ...
    def CSV_export(self) -> str:
        ...
        file_name = storage.export_to_csv(headerrow=header, bodyrow=body)
        return file_name
